...
public class CommonDialog extends Dialog {
	...
	protected ImageView noPromptIv;
	protected ViewGroup noPromptLayout;
	...
	protected void init(final Context context) {
		...
		noPromptIv = (ImageView) content.findViewById(R.id.iv_select);
		noPromptLayout = (ViewGroup) content.findViewById(R.id.layout_no_prompt);
...
//			});
	...
	public void setNoPromptLayout(View.OnClickListener listener){
		
		noPromptLayout.setVisibility(View.VISIBLE);
		noPromptIv.setOnClickListener(listener);
	}
