...
public class CnToSpell {   
    ...
    private static void initUncommonWords(){   
        ...
        putUncommonWord('鑫', "xin");   
        putUncommonWord('浏', "liu");   
        putUncommonWord('鳄', "e");  
    }   
...
//	 * @return String
//	 */
//	public static String int(char cnStr) {
...
//	
    ...
    public static void main(String[] args) {   
        ...
        System.out.println("鑫的首拼:" + getSpell("鑫", false));   
    	System.out.println(getCnASCII("测"));
        try {
			System.out.println("测试的首拼:" + getSpell(new String("测试".getBytes("utf-8"),"gbk"), true));
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}   
